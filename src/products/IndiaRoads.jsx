...
const IndiaRoads = () => {
  return (
    <>
   <div className="mx-4">
     <span className="text-2xl font-semibold mx-6 border-b-2">
        <h1>India Tourist Places :</h1>
    </span>
     <section className="flex justify-around gap-1">

         <div className="border w-1/4 flex justify-center p-1">
      ...
      <div className="border w-1/4 flex justify-center p-1">
        <span className="flex flex-col gap-1">
          ...
          <p className="w-72">
            Madurai main ,Madurai ,TamilNadu 625001.
          </p>
          <p>4.9</p>
        </span>
      </div>
      ...
      <div className="border w-1/4 flex justify-center p-1">
        <span className="flex flex-col gap-1">
          ...
          <p className="w-72">
           Beach Rd, Mahabalipuram, TamilNadu 603104.
          </p>
          <p>4.6</p>
        </span>
      </div>
     </section>
     <span className="flex justify-center mt-10 text-gray-400 hover:underline cursor-pointer hover:text-gray-600">
        <p>See More</p>
     </span>
   </div>
    </>
