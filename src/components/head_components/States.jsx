...
const States = () => {
  return (
    <>
     <div>
       <h1 className='text-xl font-semibold border-b-2 p-1 ml-2 mt-7'>
        🇮🇳 States of India
       </h1>
            <ul className='grid grid-cols-7 gap-4 mx-10 my-6 text-gray-500 font-light text-sm'>
         ...
         <span>
            <h1 className='text-xl font-semibold border-b-2 p-1 ml-2'>
            Union Territories of India
            </h1>
               <ul className='grid grid-cols-4 gap-3 mx-10 my-6 text-gray-500 font-light text-sm'>
